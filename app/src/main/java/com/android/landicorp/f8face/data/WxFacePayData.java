package com.android.landicorp.f8face.data;
...
public class WxFacePayData {
    ...
    public static final String PARAMS_CODE_TYPE = "face_code_type";
    ...
    public static final String PARAMS_PAY_RESULT = "payresult";
    public static final String PARAMS_IGNORE_PAY_RESULT = "ignore_update_pay_result";
