...
public class CusPreferenceCheckBox extends CheckBoxPreference {
    ...
    public CusPreferenceCheckBox(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    protected View onCreateView(ViewGroup parent) {
        ...
        return LayoutInflater.from(mContext).inflate(R.layout.view_preference_checkbox,parent,false);
    }
